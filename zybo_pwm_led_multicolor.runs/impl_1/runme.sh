...
HD_PWD='C:/Users/brown/Documents/sw/zybo/zybo_pwm_led_multicolor/zybo_pwm_led_multicolor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Zybo_periph_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Zybo_periph_wrapper.tcl -notrace
