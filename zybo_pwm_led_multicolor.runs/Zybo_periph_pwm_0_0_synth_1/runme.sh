...
HD_PWD='C:/Users/brown/Documents/sw/zybo/zybo_pwm_led_multicolor/zybo_pwm_led_multicolor.runs/Zybo_periph_pwm_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zybo_periph_pwm_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zybo_periph_pwm_0_0.tcl
