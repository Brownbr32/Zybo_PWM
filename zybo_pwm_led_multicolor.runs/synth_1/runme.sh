...
HD_PWD='C:/Users/brown/Documents/sw/zybo/zybo_pwm_led_multicolor/zybo_pwm_led_multicolor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zybo_periph_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zybo_periph_wrapper.tcl
