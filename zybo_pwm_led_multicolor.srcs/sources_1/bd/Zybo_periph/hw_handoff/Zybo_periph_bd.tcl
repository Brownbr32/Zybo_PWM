...
################################################################
# This is a generated script based on design: Zybo_periph
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set blue_0 [ create_bd_port -dir O blue_0 ]
  set green_0 [ create_bd_port -dir O green_0 ]
  set red_0 [ create_bd_port -dir O red_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY0 {0.211} \
   CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY1 {0.210} \
   CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY2 {0.188} \
   CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY3 {0.220} \
   CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_0 {-0.072} \
   CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_1 {-0.082} \
   CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_2 {-0.032} \
   CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_3 {-0.084} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pwm_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net pwm_0_blue [get_bd_ports blue_0] [get_bd_pins pwm_0/blue]
  connect_bd_net -net pwm_0_green [get_bd_ports green_0] [get_bd_pins pwm_0/green]
  connect_bd_net -net pwm_0_red [get_bd_ports red_0] [get_bd_pins pwm_0/red]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pwm_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pwm_0/S00_AXI/S00_AXI_reg] SEG_pwm_0_S00_AXI_reg
